...
## Présentation
Fort d'une douzaine d'années d’expérience, j’ai aujourd’hui une double casquette : celle de Lead Developer Symfony et de consultant.
J’apprécie la nouveauté, l’innovation et être moi-même force de propositions. Mon rôle de consultant m'a permis d'apporter une approche métier et technique très appréciée par les start-ups.
...
gérer des projets, de l'étude à la livraison, en lien permanent avec le client.
...
Aujourd'hui, pour chaque projet, je mets un point d'honneur à délivrer un travail de qualité. Respecter des bonnes pratiques, une architecture technique de haute qualité, l'approche CI/CD (Intégration Continue et Déploiement Continu), tant de pratiques qui me permettent de concevoir des applications web robustes et fiables.

Lors de la crise sanitaire apparue en 2020, je me suis lancé dans le stream sur la plateforme Twitch. Toujours dans cette envie de partager mes connaissances et de partager une passion commune avec mes pairs.
...
**Twitch - Streamer** - 04/2020 à aujourd'hui

Streamer sur la plateforme Twitch depuis Avril 2020. Ma chaîne a pour objectif de partager mon expérience, mes compétences dans le développement web et ma bonne humeur.

J'anime plusieurs formats lors de mes lives :
- Sessions de live coding sur un projet professionnel
- Katas
- Capsules PHP/Symfony (live orienté formation)
- Interviews & Talks

_________________________________________

**Il était une fois un dev - Fondateur** - 01/2022 à aujourd'hui

"Il était une fois un dev" est une plateforme proposant une nouvelle expérience d'apprentissage.

Nous nous concentrerons dans un premier temps sur le framework Symfony.
...
Pour mettre en forme ce concept, nous nous appuierons sur la gamification afin de donner un côté un peu plus vidéo-ludique à votre apprentissage.

_________________________________________

**Les Ateliers du R.O.I. - Lead Developer** - 06/2021 à 12/2021 - Freelance
...
**Les Ateliers du R.O.I. - Coaching** - 02/2021 à 05/2021 - Freelance
...
**Off & away - Développeur Web** - 10/2020 à 05/2021 - Freelance
...
**LIDL - Développeur Web** - 12/2020 - Freelance
...
**Mediplace - Développeur Web** -  09/2020 à 11/2020 - Freelance
...
**Top Graduate - Développeur Web** - 02/2020 à 09/2020 - Freelance
...
- Respect des bonnes pratiques, approche qualité et performance (Clean Code, DDD, BDD)
- Mise en place d’un système de paiement supplémentaire (Stripe)
- Maintenance et correctifs

_________________________________________

**Bostik - Lead Developer** - 01/2020 - Freelance
...
**C10 - Lead developer - Product Owner** - 12/2019 - Freelance
...
**Les Ateliers du R.O.I. - Consultant** - 11/2019 - Freelance
...
**Top Graduate - Développeur Web** - 12/2018 à 10/2019 - Freelance
...
**D.M.R. Formation - Formateur** - 10/2018 à 10/2019 - Freelance
...
**Funevia - Développeur Web** - 05/2018 à 06/2018 - Freelance
...
**Funerweb - Développeur Web** - 02/2018 à 11/2018 - Freelance
...
**ASTBTP 13 - Développeur Web** - 12/2017 à 01/2018 - Freelance
...
**OpenClassrooms - Mentor** - 12/2016 à aujourd’hui - Freelance

OpenClassrooms est une plateforme d'e-learning. Leader du marché, j'ai tenté l'aventure du mentorat. C'est une expérience très enrichissante, surtout humainement. Je me suis découvert des compétences pédagogiques que je ne soupçonnais pas.
...
+ de 4000 heures de mentorat
+ de 150 élèves
+ de 1200 projets validés

_________________________________________

**Les Ateliers du R.O.I. - Développeur** - 08/2011 à 03/2018 - Salarié
...
Réalisations :
- Relation avec les clients (face à face, email, téléphone, webinar)
- Etude et analyse (BDD, UML, Merise)
- Mise en place des nouvelles pratiques de développement (PHP 5 & 7, POO, PSR)
- Mise en place de processus de recrutement
- Mise en place du versionning (SVN, Git & Gitlab/Github)
- Mise en place de méthodes de travail et de communication (Trello, Slack)
- Conception d’un framework “maison” à mon arrivée en 2011 (PHP 5, POO, MySQL)
- Développement (Symfony 2/3,Doctrine 2, Twig, MySQL, HTML 5, CSS 3, Redis, NodeJS, Javascript, JQuery)
- Mise en place du framework Scrum (Scrum Master)
- Rédaction de réponse d’appels d’offre, cahier des charges et de PAQ (Gestion de projet)
- Innovation, étude et conception d’un outil clé en main “Phone Booster” (Entrepreneuriat, gestion de projet)

## Formations
* **2022** : Certification "Advanced" Symfony 6
* **2008-2010** : BTS Informatique de gestion - Option Développeur d'application
